...
\title{A systematic review of validation methods for geosimulation models}

\titlerunning{A systematic review of validation methods for geosimulation models}

\author{Juste Raimbault}{Dummy University Computing Laboratory, [optional: Address], Country \and My second affiliation, Country \and \url{http://www.myhomepage.edu} }{johnqpublic@dummyuni.org}{https://orcid.org/0000-0002-1825-0097}{(Optional) author-specific funding acknowledgements}%TODO mandatory, please use full name; only 1 author per \author macro; first two parameters are mandatory, other parameters can be empty. Please provide at least the name of the affiliation and the country. The full address is optional
...
% conf GIScience 2023 https://giscience2023.github.io/
